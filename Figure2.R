...
pdf('plot/Fig2a.pdf',height = 4,width = 12)
...
ggsave('plot/Fig2b.pdf',p,width = 4,height = 2.5)
...
ggsave('plot/Fig2c.pdf',p,width = 4,height = 2.8)
...
ggsave(str_glue('plot/Fig2d.pdf'),p,width = 8,height = 3)
